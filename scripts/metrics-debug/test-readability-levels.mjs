...
const complexText =
  'Recent developments in artificial intelligence technology and their implications for various industries. The progress in AI brings significant benefits, but it also poses challenges that need to be addressed.';
...
async function testReadabilityLevels() {
  try {
    ...
    console.log(
      `   Flesch Reading Ease: ${simpleScores.fleschReadingEase} (Should be 80-100)`,
    );
    console.log(
      `   Flesch-Kincaid: ${simpleScores.fleschKincaid} (Should be low)`,
    );
    console.log('');
    ...
    console.log(
      `   Flesch Reading Ease: ${complexScores.fleschReadingEase} (Should be 30-50)`,
    );
    ...
    console.log(
      `   Flesch Reading Ease: ${jobScores.fleschReadingEase} (Currently getting 2.04)`,
    );
    ...
    if (simpleScores.fleschReadingEase < 60) {
      console.log(
        '🚨 PROBLEM: Simple text should have high readability (80+), but got',
        simpleScores.fleschReadingEase,
      );
    } else {
      console.log(
        '✅ Simple text readability looks correct:',
        simpleScores.fleschReadingEase,
      );
    }
    ...
    if (jobScores.fleschReadingEase < 10) {
      console.log(
        "🤔 Job text is extremely difficult to read (0-10 range). This might be correct for technical content, but let's verify...",
      );
      ...
      if (directSimple > 60 && directComplex < 50) {
        console.log(
          '✅ Library is working correctly - our job text is legitimately very complex',
        );
      } else {
