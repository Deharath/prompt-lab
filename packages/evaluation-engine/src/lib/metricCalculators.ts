 ...
 */
function countNGramOverlaps(candidateNGrams: string[], referenceNGrams: string[]): number {
 ...
 */
export function calculateRougeScores(candidate: string, reference: string): RougeScores {
 ...
 */
function calculateRougeN(candidateTokens: string[], referenceTokens: string[], n: number): number {
  const candidateNGrams = generateNGrams(candidateTokens, n);
  const referenceNGrams = generateNGrams(referenceTokens, n);
 ...
 */
function calculateRougeL(candidateTokens: string[], referenceTokens: string[]): number {
