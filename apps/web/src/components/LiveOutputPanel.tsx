    ...
    <Card>
      <div className="p-8 space-y-6">
        ...
        <div className="relative">
          <div
            className="rounded-xl p-6 min-h-[300px] max-h-[500px] overflow-auto shadow-inner transition-colors duration-300 bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:from-black dark:via-gray-900 dark:to-gray-800"
            aria-live="polite"
