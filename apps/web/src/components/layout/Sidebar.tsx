...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div
        className={`hidden transition-all duration-300 ease-in-out lg:fixed lg:top-16 lg:bottom-0 lg:z-50 lg:flex lg:flex-col ${collapsed ? 'lg:w-16' : 'lg:w-80'} ${className} `}
        {...props}
      >
        <AppSidebar
